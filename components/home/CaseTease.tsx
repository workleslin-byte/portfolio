      ...
      <div className="mx-auto max-w-dossier px-[var(--gutter)] pb-20 pt-12 sm:pb-28 sm:pt-16 md:pt-20">
        <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2 md:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <Link
              href={c.href}
              className="case-link group mt-8 inline-flex w-fit items-center gap-2 rounded-full border border-[color:var(--accent)]/45 px-5 py-2.5 font-mono text-[12px] uppercase tracking-[0.16em] text-[color:var(--accent)]"
            >
              Read the full case
              <span
                aria-hidden="true"
