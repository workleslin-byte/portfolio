  ...
  return (
    <>
      ...
      <section className="w-full bg-obsidian px-6 pt-32 pb-16 md:px-12 md:pt-[8rem]">
        <p className="mb-6 font-mono text-[11px] uppercase tracking-[0.35em] text-linen/35">
          ( THE WORK )
        </p>
        ...
        <h1
          className="font-display font-extrabold uppercase leading-[0.92] text-white/50"
          style={{ fontSize: "clamp(2.5rem, 6vw, 6rem)" }}
        >
          what actually works.
        </h1>

        <p className="mt-8 max-w-2xl font-sans text-sm leading-relaxed text-linen/35">
